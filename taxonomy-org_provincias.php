...
<div class="container-fluid">
 		...
 		<?php if ( have_posts() ) : ?>
            ...
            <div class="row">
				<div class="col-sm-10 col-sm-offset-1">
                    <h2 class="text-center page-title"> <?php $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) ); echo $term->name; ?>                      
                      <?php /* if ( is_tax('org_provincias','organizacion-mundial')) { ?>Organización Mundial<?php }
                      elseif ( is_tax('org_provincias','han-sido-superioras-provinciales')) { ?>Han sido Superioras Provinciales<?php }
                      elseif ( is_tax('org_provincias','provincia-chilena')) { ?>Provincia Chilena<?php } */ ?></h2>
 ...
 ?> <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	?>
        ...
        <div class="col-sm-4 margin-sm persona">
